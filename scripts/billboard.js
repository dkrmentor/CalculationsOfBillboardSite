...
function billboard() {
  ...
  console.log(totalSqFt);
    ...
    function showOrderSummary() {
      ...
      const orderDetails = document.getElementById('tab1orderDetails');
