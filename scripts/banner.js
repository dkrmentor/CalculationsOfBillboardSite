function banner() {
  ...
  const straightcutedgeSwitchCheckbox = document.getElementById("tab2straightcutedgeSwitch");
  ...
  const hqPrintingSwitchCheckbox = document.getElementById("tab2hqPrintingSwitch");
  const expressPrintSwitchCheckbox = document.getElementById("tab2expressPrintSwitch");
  const artServiceSwitchCheckbox = document.getElementById("tab2artServiceSwitch");
  ...
  function calculateGrommetCount() {
    ...
    const grommetsCount = (parseFloat(grommetslen) + parseFloat(grommetswid)) * 2;
  ...
  function calculateAJAXPrice() {
    ...
    let bpo7, bpo13, bpo9, basePrice = 0;
  ...
  function showOrderSummary() {
    ...
    const straightcutedgeSwitch = straightcutedgeSwitchCheckbox.checked ? "Yes" : "No";
    ...
    const orderDetails = document.getElementById("tab2orderDetails");
    orderDetails.innerHTML = `
        ...
        <p><strong>Total Price (with shipping):</strong> ${basePriceWithShipping.toFixed(2)}</p>
        <p><strong>Material:</strong> ${material7oz} ${material13oz} ${material9oz}</p>
        ...
        <p><strong>Grommets:</strong> ${grommetsSwitch}</p>
    
        <p> <strong>Grommets Count:</strong> ${grommetsCount}</p>
      
        <p><strong>Pole Pocket:</strong> ${polepocketSwitch}</p>
        <p><strong>Straight Cut Edge:</strong> ${straightcutedgeSwitch}</p>
        <p><strong>Webbing:</strong> ${webbingSwitch}</p>
        <p><strong>Proof:</strong> ${proofSwitch}</p>
        <p><strong>HQ Printing:</strong> ${hqPrintingSwitch}</p>
        <p><strong>Express Print:</strong> ${expressPrintSwitch}</p>
  ...
  document.getElementById("tab2orderNowBtn").addEventListener("click", function () {
  ...
  document.getElementById("tab2quantity").addEventListener("input", calculateAJAXPrice);
  document.getElementById("tab2length-feet").addEventListener("input", calculateAJAXPrice);
  document.getElementById("tab2length-inch").addEventListener("input", calculateAJAXPrice);
  document.getElementById("tab2width-feet").addEventListener("input", calculateAJAXPrice);
  document.getElementById("tab2width-inch").addEventListener("input", calculateAJAXPrice);
  //material7oz
  document.getElementById("tab2material7oz").addEventListener("change", calculateAJAXPrice);
  document.getElementById("tab2material13oz").addEventListener("change", calculateAJAXPrice);
  document.getElementById("tab2material9oz").addEventListener("change", calculateAJAXPrice);
  document.getElementById("tab2proofSwitch").addEventListener("change", calculateAJAXPrice);
  document.getElementById("tab2hqPrintingSwitch").addEventListener("change", calculateAJAXPrice);
  document.getElementById("tab2expressPrintSwitch").addEventListener("change", calculateAJAXPrice);
  document.getElementById("tab2artServiceSwitch").addEventListener("change", calculateAJAXPrice);
  document.getElementById("tab2hemSwitch").addEventListener("change", calculateAJAXPrice);
  document.getElementById("tab2grommetsSwitch").addEventListener("change", calculateAJAXPrice);
  document.getElementById("tab2polepocketSwitch").addEventListener("change", calculateAJAXPrice);
  document.getElementById("tab2straightcutedgeSwitch").addEventListener("change", calculateAJAXPrice);
  document.getElementById("tab2webbingSwitch").addEventListener("change", calculateAJAXPrice);
